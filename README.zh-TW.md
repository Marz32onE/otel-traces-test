...
| **API**            | Go (Gin)                        | 端點：`POST /api/message`（JetStream）、`POST /api/message-core`（Core）、`POST /api/message-mongo`（MongoDB 插入）、`...-mongo-update`、`...-mongo-read`、`...-mongo-delete`；回傳 `trace_id` | `8088`                                 |
