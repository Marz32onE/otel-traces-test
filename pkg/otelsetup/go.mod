module github.com/Marz32onE/otel-traces-test/pkg/otelsetup
...
replace github.com/Marz32onE/instrumentation-go/otel-mongo/v2 => ../instrumentation-go/otel-mongo/v2
